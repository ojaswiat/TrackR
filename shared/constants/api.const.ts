...
export const TRANSACTIONS_FETCH = `${API_TRANSACTIONS}/fetch`;
export const TRANSACTIONS_ADD = `${API_TRANSACTIONS}/add`;
export const TRANSACTIONS_EDIT = `${API_TRANSACTIONS}/edit`;
export const TRANSACTIONS_REMOVE = `${API_TRANSACTIONS}/remove`;
